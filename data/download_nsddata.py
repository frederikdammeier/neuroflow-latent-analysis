...
# Download ROIs
# for sub in [1,2,5,7]:
#     os.system('aws s3 cp s3://natural-scenes-dataset/nsddata/ppdata/subj{:02d}/func1pt8mm/roi/ nsddata/ppdata/subj{:02d}/func1pt8mm/roi/ --recursive --no-sign-request'.format(sub,sub))
